...
bool Sphere::intersectRay(const Ray &ray, Vec &point, double &distance) const
{
  float b, c, t[2];
  float delta;
...
bool Plane::intersectRay(const Ray &ray, Vec &point, double &distance) const
{
...
void Sphere::normalAt(const Vec &point, Vec &normal) const
{
